...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://worldofdragon.us.eu.org/CrashVPN/main/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@openersfamily\n"
  ...
  echo -e "  \033[1;33mMAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@openersfamily\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://worldofdragon.us.eu.org/CrashVPN/main/crashvpn > /dev/null 2>&1

...
fun_menu() {
    if [[ "${message_from_id[$id]}" = "$id_admin" ]]; then
        local env_msg
        env_msg="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
        env_msg+="<b>SEJA BEM VINDO(a) AO BOT CrashVPN</b>\n"
        env_msg+="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n"
        env_msg+="âš ï¸ <i>SELECIONE UMA OPCAO ABAIXO !</i>\n\n"
        ...
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e "ðŸš« VC ESTA SUSPENSO ðŸš«\n\nCONTATE O ADMINISTRADOR")"
        return 0
        ...
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e ðŸš« ACESSO NEGADO ðŸš«)"
        return 0
    fi
}
...
fun_ajuda() {
    ...
    if [[ "$id_chatuser" = "$id_admin" ]]; then
        local env_msg
        env_msg="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
        env_msg+="<b>BEM VINDO(a) AO BOT CrashVPN</b>\n"
        env_msg+="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n"
        env_msg+="âš ï¸ <i>Comandos Disponiveis</i>\n\n"
        env_msg+="[<b>01</b>] /menu = Exibe menu\n"
        env_msg+="[<b>02</b>] /ajuda = Informacoes sobre opcoes\n\n"
        env_msg+="âš ï¸ <i>OpÃ§Ãµes Disponiveis</i>\n\n"
        env_msg+="â€¢ <u>CRIAR USUARIO</u> = Cria usuario ssh\n\n"
        env_msg+="â€¢ <u>CRIAR TESTE</u> = Cria teste ssh\n\n"
        env_msg+="â€¢ <u>REMOVER</u> = Remove usuario ssh\n\n"
        env_msg+="â€¢ <u>INFO USUARIOS</u> = Informacoes do usuario\n\n"
        env_msg+="â€¢ <u>USUARIOS ONLINE</u> = Exibe UsuÃ¡rios onlines\n\n"
        env_msg+="â€¢ <u>INFO VPS</u> = Informacoes do servidor\n\n"
        env_msg+="â€¢ <u>ALTERAR SENHA</u> = Altera senha ssh\n\n"
        env_msg+="â€¢ <u>ALTERAR LIMITE</u> = Altera limite ssh\n\n"
        env_msg+="â€¢ <u>ALTERAR DATA</u> = Altera data ssh\n\n"
        env_msg+="â€¢ <u>EXPIRADOS</u> = Remove ssh expirados\n\n"
        env_msg+="â€¢ <u>BACKUP</u> = Cria Backup ssh e revendas\n\n"
        env_msg+="â€¢ <u>OTIMIZAR</u> = Limpa o cache - ram\n\n"
        env_msg+="â€¢ <u>SPEEDTESTE</u> = Teste de conexao\n\n"
        env_msg+="â€¢ <u>ARQUIVOS</u> = Hospeda Arquivos\n\n"
        env_msg+="â€¢ <u>REVENDAS</u> = Gerenciar Revendas\n\n"
        env_msg+="â€¢ <u>AUTOBACKUP</u> = lig/Des Backup automatico\n\n"
        env_msg+="â€¢ <u>RELATORIO</u> = Informacoes sobre revendas\n\n"
        env_msg+="â€¢ <u>AJUDA</u> = Informacoes sobre opcoes\n\n"
...
fun_adduser() {
    [[ "$(grep -wc ${callback_query_from_username} $suspensos)" != '0' ]] && {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "âš ï¸ VC ESTA SUSPENSO! CONTATE O ADMINISTRADOR"
        return 0
    }
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¤ CRIAR USUARIO ðŸ‘¤\n\nNome do usuario:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "ðŸš« ACESSO NEGADO ðŸš«"
        return 0
    }
}
...
fun_del_user() {
    ...
    [[ "${message_from_id[$id]}" = "$id_admin" ]] && {
        ...
        [[ ! -e /etc/bot/revenda/${message_from_username}/usuarios/$usuario ]] && {
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e "âŒ O USUARIO NAO EXISTE âŒ")" \
                --parse_mode html
            _erro='1'
            return 0
        }
...
alterar_limite_user() {
    ...
    [[ -d /etc/bot/revenda/${message_from_username} ]] && {
        ...
        [[ "$limite" -gt "$_limTotal" ]] && {
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e "âŒ VC NAO TEM LIMITE SUFICIENTE âŒ\n\nLimite Atual: $_limTotal ")" \
                --parse_mode html
            _erro='1'
            return 0
        }
        ...
        [[ "$_limsomarev2" -gt "$_limTotal" ]] && {
            ...
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e "âŒ Vc nao tem limite suficiente\n\nLimite restante: $_restant1 ")" \
                --parse_mode html
            _erro='1'
            return 0
        }
...
alterar_data_user() {
    ...
    [[ "$(echo -e "$inputdate" | sed -e 's/[^/]//ig')" != '//' ]] && {
        ...
        [ $today -ge $timemachine ] && {
            verify='1'
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e "âŒ Erro! Data invalida")" \
                --parse_mode html
            _erro='1'
            return 0
        }
...
ver_users() {
    if [[ "${callback_query_from_id[$id]}" = "$id_admin" ]]; then
        ...
        local info_users
        info_users='=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n'
        info_users+='<b>INFORMACOES DOS USUARIOS</b>\n'
        info_users+='=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n'
        info_users+='âš ï¸ Exibe no formato abaixo:\n\n'
        info_users+='<code>USUÃRIO SENHA LIMITE DATA</code>\n'
        ...
        fun_infu() {
            ...
            for user in $(cat /etc/passwd | awk -F : '$3 >= 1000 {print $1}' | grep -v nobody); do
                ...
                info+="$user â€¢ $senha â€¢ $limite â€¢ $data"
                echo -e "$info"
            done
        }
        fun_infu >$arq_info
...
monitor_ssh() {
    if [[ "${callback_query_from_id[$id]}" = "$id_admin" ]]; then
        ...
        local info_on
        info_on='=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n'
        info_on+='<b>MONITOR USUARIOS ONLINES</b>\n'
        info_on+='=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n'
        info_on+='âš ï¸ Exibe no formato abaixo:\n\n'
        info_on+='<code>USUÃRIO  ONLINE/LIMITE  TEMPO\n</code>'
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "$(echo -e $info_on)" \
            --parse_mode html
        fun_online() {
            ...
            for user in $(cat /etc/passwd | awk -F : '$3 >= 1000 {print $1}' | grep -v nobody); do
                ...
                [[ $conex -gt '0' ]] && {
                    ...
                    info2+="===========================\n"
                    info2+="ðŸŸ¢ $user       $conex/$lim       â³$timerr\n"
                }
            done
            echo -e "$info2"
        }
        ...
        fun_online() {
            ...
            for user in $(ls /etc/bot/revenda/${callback_query_from_username}/usuarios); do
                ...
                [[ $conex -gt '0' ]] && {
                    timerr="$(ps -o etime $(ps -u $user | grep sshd | awk 'NR==1 {print $1}') | awk 'NR==2 {print $1}')"
                    info2+="------------------------------\n"
                    info2+="ðŸ‘¤$user       $conex/$lim       â³$timerr\n"
                }
            done
            echo -e "$info2"
        }
...
fun_verif_user() {
    ...
    [[ "${message_from_id[$id]}" = "$id_admin" ]] && {
        [[ ! -e /etc/bot/info-users/$user ]] && {
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e âŒ Usuario $user nao existe !)" \
                --parse_mode html
            _erro='1'
            return 0
        }
...
infovps() {
    ...
    local info
    info="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
...
fun_download() {
    ...
    [[ -z "$Opc" ]] && {
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e "âŒErro tente novamente")"
        _erro='1'
        return 0
    }
    _file2=$2
...
fun_del_arq() {
    ...
    [[ -e /etc/bot/arquivos/$_file ]] && {
        ...
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e "âŒ Opcao invalida")"
        _erro='1'
        return 0
    }
}
...
otimizer() {
    ...
    ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
        --text "ðŸ§¹ LIMPANDO CACHE DO SERVIDOR"
    apt-get autoclean -y
    ...
    res=$(expr $MEM1 - $MEM2)
    local sucess
    sucess="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
...
speed_test() {
    ...
    ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
        --text "ðŸš€ TESTANDO VELOCIDADE DO SERVIDOR"
    ...
    msg+="<b>ðŸš€ VELOCIDADE DO SERVIDOR ðŸš€</b>\n"
    msg+="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n"
...
backup_users() {
    ...
    ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
        --text "â™»ï¸ CRIANDO BACKUP DE USUARIOS"
    ...
    ShellBot.sendDocument --chat_id ${id_admin} \
        ...
        --caption "$(echo -e "â™»ï¸ BACKUP DE USUARIOS â™»ï¸")"
    return 0
}
...
sobremim() {
    local msg
    msg="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
    msg+="<b>ðŸ¤– BOT CrashVPN MANAGER ðŸ¤–</b>\n"
    msg+="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n"
    msg+="<b>Desenvolvido por:</b> @openersfamily\n"
    msg+="<b>Canal Oficial:</b> @CrashVPN\n\n"
    msg+="Fui criado com o propÃ³sito de fornecer informaÃ§Ãµes e ferramentas para gestÃ£o VPN em servidores ðŸ§ GNU/Linux ðŸ§.\n\n"
    msg+="<b>Menu:</b> /menu\n"
    ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
        --text "$(echo -e $msg)" \
        --parse_mode html
...
fun_add_teste() {
    if [[ "$(grep -wc ${callback_query_from_username} $suspensos)" != '0' ]]; then
        ...
        [[ "$_limsomarev2" -gt "$_limTotal" ]] && {
            ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
                --text "âŒ VC NAO TEM LIMITE DISPONIVEL!"
            return 0
        } || {
            ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
                --text "ðŸ‘¤ CRIAR TESTE ðŸ‘¤\n\nQuantas horas deve durar EX: 1:" \
...
fun_teste() {
    ...
    [[ -z $t_time ]] && {
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e "âŒ Erro tente novamente")" \
            --parse_mode html
        return 0
        _erro='1'
    }
...
fun_exp_user() {
    if [[ "${callback_query_from_id[$id]}" == "$id_admin" ]]; then
        ...
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "âŒ›ï¸ USUARIOS SSH EXPIRADOS REMOVIDOS"
        return 0
    elif [[ "$(grep -wc "${callback_query_from_username}" $ativos)" != '0' ]]; then
        [[ "$(grep -wc ${callback_query_from_username} $suspensos)" != '0' ]] && {
            ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
...
relatorio_rev() {
    if [[ "${callback_query_from_id[$id]}" = "$id_admin" ]]; then
        ...
        local msg
        msg="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
        msg+="<b>ðŸ“Š RELATORIO | INFORMACOES</b>\n"
        msg+="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n\n"
        ...
        [[ $_cont_revt != '0' ]] && {
            ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
                --text "ðŸ“Š CRIANDO RELATORIO !"
        } || {
            ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
                --text "âš ï¸ NENHUM REVENDEDOR ENCONTRADO !"
            return 0
        }
        echo -e "RELATORIO DOS REVENDEDORES\n\nTotal: $_cont_revt  -  $(printf 'Data: %(%d/%m/%Y)T\n')\n=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=" >/tmp/Relatorio.txt
        ...
        [[ $(grep -wc 'SUBREVENDA' /etc/bot/revenda/${callback_query_from_username}/${callback_query_from_username}) == '0' ]] && {
            ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
                --text "âš ï¸ NENHUM SUB REVENDEDOR ENCONTRADO !"
            return 0
        }
        fun_contsub() {
        ...
        msg+="<b>User:</b> @${callback_query_from_username}\n"
        msg+="<b>ID:</b> <code>${callback_query_from_id}</code>\n"
        echo -e "RELATORIO DOS SUB REVENDEDORES\n\nTotal: $_cont_atv  -  $(printf 'Data: %(%d/%m/%Y)T\n')\n=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=" >/tmp/Relatorio-${callback_query_from_username}.txt
        while read _sublist; do
            _usub="$(echo $_sublist | awk '{print $2}')"
...
backup_auto() {
    ShellBot.sendDocument --chat_id $id_admin \
        ...
        --caption "$(echo -e "â™»ï¸ BACKUP AUTOMATICO â™»ï¸")"
...
msg_bem_vindo() {
    local msg
    msg="âœŒï¸ðŸ˜ƒ Ola <b>${message_from_first_name[$id]}</b>\n\nSEJA BEM VINDO(a)\n\n"
...
fun_add_revenda() {
    ...
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¥ ADICIONAR REVENDEDOR ðŸ‘¥\n\nInforme o nome:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "ðŸš« ACESSO NEGADO ðŸš«"
...
del_rev() {
    ...
    [[ "${message_from_id[$id]}" == "$id_admin" ]] && {
        [[ "$(grep -wc "$_cli_rev" $ativos)" != '0' ]] && {
            ...
            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                --text "$(echo -e âŒ REVENDEDEDOR NAO EXISTE âŒ)"
            return 0
        }
    } || {
...
fun_lim_rev() {
    ...
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "â™¾ ALTERAR LIMITE REVENDA â™¾\n\nInforme o user dele [Ex: @openersfamily]:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "ðŸš« ACESSO NEGADO ðŸš«"
...
fun_dat_rev() {
    ...
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ“† ALTERAR DATA REVENDA ðŸ“†\n\nInforme o user dele [Ex: @openersfamily]:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "ðŸš« ACESSO NEGADO ðŸš«"
...
dat_rev() {
    ...
    [[ -d "/etc/bot/suspensos/$_revd" ]] && {
        ...
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e "âš ï¸ $_revd ESTAVA SUSPENSO E FOI REATIVADO !")" \
            --parse_mode html
    } || {
...
fun_list_rev() {
    ...
    if [[ "${callback_query_from_id[$id]}" == "$id_admin" ]]; then
        ...
        local msg1
        msg1="=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\nðŸ“ƒ LISTA DE SUB REVENDEDORES !\n=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=\n"
...
fun_susp_rev() {
    ...
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ”’ SUSPENDER REVENDEDOR ðŸ”’\n\nInforme o user dele [Ex: @openersfamily]:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "ðŸš« ACESSO NEGADO ðŸš«"
...
fun_menurevenda() {
    ...
    [[ "${callback_query_from_id[$id]}" == "$id_admin" ]] || [[ "$(grep -wc ${callback_query_from_username} $ativos)" != '0' ]] && {
        ShellBot.editMessageText --chat_id ${callback_query_message_chat_id[$id]} \
            ...
            --text "SELECIONE UMA OPÃ‡ÃƒO ABAIXO:" \
...
while :; do
    ...
    for id in $(ShellBot.ListUpdates); do
        ...
        (
            ...
            # RequisiÃ§Ãµes somente no privado.
            [[ ${message_chat_type[$id]} != 'private' ]] && continue
            CAD_ARQ=/tmp/cad.${message_from_id[$id]}
            if [[ ${message_entities_type[$id]} == bot_command ]]; then
                #Verifica se a mensagem enviada pelo usuÃ¡rio Ã© um comando vÃ¡lido.
            ...
            if [[ ${message_reply_to_message_message_id[$id]} ]]; then
                ...
                'ðŸ‘¤ CRIAR USUARIO ðŸ‘¤\n\nNome do usuario:')
                    ...
                    [[ "$(awk -F : '$3 >= 1000 { print $1 }' /etc/passwd | grep -w ${message_text[$id]} | wc -l)" != '0' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro! USUARIO INVALIDO âŒ\n\nâš ï¸ Informe Outro Nome..")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
                    ...
                    [[ "$sizemin" -lt '4' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro !\n\nUse no mÃ­nimo 4 caracteres\n[EX: test]")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
                ...
                'Validade em dias:')
                    ...
                    [[ "(grep -w ${message_text[$id]} /etc/passwd)" = '0' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e âŒ Erro ao criar usuario !)" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
                ...
                'ðŸ“¥ ARQUIVOS DISPONIVEIS ðŸ“¥\n\nDeseja baixar? Sim ou Nao?:')
                    ...
                    [[ "${message_text[$id]}" = @(Sim|sim|SIM) ]] && {
                        ...
                        msg_cli+="<b>ARQUIVOS PRE-CONFIGURADOS </b>â—\n"
                        msg_cli+="â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ â‰ \n\n"
                ...
                'Informe o Numero do Arquivo:')
                    ...
                    [[ ${message_text[$id]} != ?(+|-)+([0-9]) ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Opcao Invalida âŒ \n\nâš ï¸ Ultilize apenas numeros [EX: 1]")" \
                            --parse_mode html
                        ShellBot.sendMessage --chat_id ${message_from_id[$id]} \
                            --text "<b>âœ… CRIADO COM SUCESSO âœ…</b>\n\nIP: $(cat /etc/IP)\nUSUARIO: <code>$(awk -F " " '/Nome/ {print $2}' $CAD_ARQ)</code>\nSENHA: <code>$(awk -F " " '/Senha/ {print $2}' $CAD_ARQ)</code>\nLIMITE: $(awk -F " " '/Limite/ {print $2}' $CAD_ARQ)\nEXPIRA EM: $(awk -F " " '/Validade/ {print $2}' $CAD_ARQ)" \
                            --parse_mode html
                    ...
                    break
                    ;;
                'ðŸ—‘ REMOVER USUARIO ðŸ—‘\n\nNome do usuario:')
                    verifica_acesso
                    [[ "$_erro" == '1' ]] && break
                    fun_del_user ${message_text[$id]}
                    [[ "$_erro" == '1' ]] && break
                    ShellBot.sendMessage --chat_id ${message_from_id[$id]} \
                        --text "âœ… *Removido com sucesso.* ðŸš®" \
                        --parse_mode markdown
                    ;;
                'ðŸ” Alterar Senha ðŸ”\n\nNome do usuario:')
                    verifica_acesso
                ...
                'Nova senha:')
                    ...
                    [[ "$sizepass" -lt '4' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro !\n\nâš ï¸ Use mÃ­nimo 4 caracteres [EX: 1234]")" \
                            --parse_mode html
                        break
                    }
                ...
                'informe os dias ou data:')
                    ...
                    [[ ${message_text[$id]} != ?(+|-)+([0-9/]) ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro! Siga o exemplo\n\nDias formato [EX: 30]\nData formato [EX: 30/12/2019]")" \
                            --parse_mode html
                        break
                    }
                ...
                'ðŸ—‘Excluir Arquivo\nInforme o Numero do Arquivo:')
                    [[ ${message_text[$id]} != ?(+|-)+([0-9]) ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro ao Excluir arquivo ! \n\nâš ï¸ Ultilize apenas numeros [EX: 1]")" \
                            --parse_mode html
                        break
                    } || {
                        fun_del_arq ${message_text[$id]}
                        ShellBot.sendMessage --chat_id ${message_from_id[$id]} \
                            --text "âœ… *Excluido com sucesso* âœ…" \
                            --parse_mode markdown
                        break
                    }
                    ;;
                'ðŸ“¤ HOSPEDAR ARQUIVOS ðŸ“¤\n\nEnvie-me o arquivo:')
                    if [ "${update_id[$id]}" ]; then
                        ...
                        [[ $download_file -eq 1 ]] && {
                            ...
                            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                                --text "$(echo -e "âŒ Erro ao receber arquivo âŒ")" \
                                --parse_mode markdown
                            break
                        }
                    fi
                ...
                'Informe o user dele [Ex: @openersfamily]:')
                    ...
                    [[ -z $_VAR1 ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro \n\nâš ï¸ Informe o user [EX: @openersfamily]")" \
                            --parse_mode html
                        break
                    }
                    [[ -d /etc/bot/revenda/$_VAR1 ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ O Revendedor ${message_text[$id]} ja existe")" \
                            --parse_mode html
                        break
                    }
                ...
                'Quantas SSH ele pode criar:')
                    ...
                    [[ ${message_text[$id]} != ?(+|-)+([0-9]) ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Erro ! \n\nâš ï¸ Ultilize apenas numeros [EX: 10]")" \
                            --parse_mode html
                        break
                    }
                    [[ "${message_from_id[$id]}" != "$id_admin" ]] && {
                ...
                'â™¾ ALTERAR LIMITE REVENDA â™¾\n\nInforme o user dele [Ex: @openersfamily]:')
                    ...
                    [[ "${message_from_id[$id]}" == "$id_admin" ]] && {
                        [[ $(grep -wc $_Var1 $ativos) != '0' ]] && {
                            ...
                            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                                --text "$(echo -e "âŒ Revendedor ${message_text[$id]} nao existe")" \
                                --parse_mode html
                            break
                        }
                    }
                    [[ $(grep -w ${message_from_username} $ativos | awk '{print $NF}') == 'revenda' ]] && {
                        [[ "$(grep -wc "$_Var1" /etc/bot/revenda/${message_from_username}/${message_from_username})" != '0' ]] && {
                            ...
                            ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                                --text "$(echo -e "âŒ O Sub-revendedor nao existe")" \
                                --parse_mode html
                            break
                        }
                    }
                ...
                'Informe o Limite SSH:')
                    ...
                    lim_rev $CAD_ARQ
                    ShellBot.sendMessage --chat_id ${message_from_id[$id]} \
                        --text "$(echo -e "=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—\n<b>âœ… LIMITE REVENDA ALTERADO !</b> !\n=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—\n\n$(<$CAD_ARQ)")" \
                        --parse_mode html
                    # ALTERAR DATA
                    ;;
                'ðŸ“† ALTERAR DATA REVENDA ðŸ“†\n\nInforme o user dele [Ex: @openersfamily]:')
                    verifica_acesso
                    [[ "$_erro" == '1' ]] && break
                    _VAR1=$(echo -e ${message_text[$id]} | awk -F '@' {'print $2'})
                    [[ -z $_VAR1 ]] && {
                    ...
                    if [[ -d /etc/bot/revenda/$_VAR1 ]]; then
                        ...
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ O Revendedor ${message_text[$id]} nao existe")" \
                            --parse_mode html
                        break
                    fi
                    ;;
                'Dias de acesso [Ex: 30]:')
                    ...
                    dat_rev $CAD_ARQ
                    ShellBot.sendMessage --chat_id ${message_from_id[$id]} \
                        --text "$(echo -e "=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—\n<b>âœ… DATA REVENDA ALTERADA !</b> !\n=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—=Ã—\n\n$(<$CAD_ARQ)")" \
                        --parse_mode html
                    ;;
                    # SUSPENDER REVENDEDOR
                'ðŸ”’ SUSPENDER REVENDEDOR ðŸ”’\n\nInforme o user dele [Ex: @openersfamily]:')
                    _VAR1=$(echo -e ${message_text[$id]} | awk -F '@' {'print $2'})
                    [[ -z $_VAR1 ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "âŒ Revendedor ${message_text[$id]} nao existe")" \
